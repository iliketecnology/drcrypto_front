  ...
  sections: [
    ...
    },
    {
      ...
      ul: [
        ...
        'Valor máximo por transação: R$ 250.000,00.',
  ...
  sections: [
    ...
    },
    {
      ...
      ul: [
        ...
        'Maximum per transaction: R$ 250,000.00.',
  ...
  sections: [
    ...
    },
    {
      ...
      ul: [
        ...
        'Valor máximo por transacción: R$ 250.000,00.',
...
const PRIVACY_ES: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      p: ['Para ejecutar una operación de swap USDT→PIX, recopilamos exclusivamente:'],
      ul: [
    ...
    {
      h: '6. Compartición',
      p: ['Compartimos solo lo estrictamente necesario para ejecutar el servicio:'],
      ul: [
